...
export default function CampaignReader({
  ...
  async function loadNextVerse() {
    ...
    try {
      ...
      const nextVerseResponse = await fetch(`/api/campaigns/${campaign.slug}/next-verse`, {
        method: 'POST',
        headers: {
        ...
        <div className="mb-3">
          ...
          <Card className="p-4 bg-gradient-to-l from-primary/10 to-accent/10 border-2">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-xl font-bold mb-1">نام کمپین: {campaign.name}</h1>
        ...
        {!campaign.is_active ? (
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="border-t-2 border-border pt-5 mb-5">
              <h3 className="text-xl font-semibold mb-3 text-center text-primary">ترجمه (فولادوند):</h3>
